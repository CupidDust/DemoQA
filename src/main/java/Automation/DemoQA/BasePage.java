...
public class BasePage {
    ...
    public void ElementsCheck() {
       ...
       WebElement elementsText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[contains(text(), 'Elements')]")));
...
//    WebElement elementsText = driver.findElement(By.xpath("//h5[.='Elements']"));
    ...
    public void FormsCheck() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
       WebElement formsText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[contains(text(), 'Forms')]")));
...
//         Scroll to the element before checking its text
    ...
    public void Alerts_Frame_WindowsCheck() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
       WebElement Alerts_Frame_WindowsText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[contains(text(), 'Alerts, Frame & Windows')]")));
...
//         Scroll to the element before checking its text
    ...
    public void WidgetsCheck() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
       WebElement WidgetsText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[contains(text(), 'Widgets')]")));
...
//         Scroll to the element before checking its text
    ...
    public void InteractionsCheck() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
       WebElement InteractionsText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[contains(text(), 'Interactions')]")));
...
//         Scroll to the element before checking its text
    ...
    public void Book_Store_ApplicationCheck() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
       WebElement Book_Store_ApplicationText = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[contains(text(), 'Book Store Application')]")));
